 ...
 */
class ImageHotspotChildModuleRenderLibraryLayoutController extends RESTController {
    /**
    ...
    public static function index( WP_REST_Request $request ): WP_REST_Response {
        ...
        $response = [
            'html' => ImageHotspotChild::render_library_layout($library_id),
        ];
...
class ImageHotspotChildModuleGetDiviLayoutsController extends RESTController {
    ...
    public static function index( WP_REST_Request $request ): WP_REST_Response {
        ...
        $response = ImageHotspotChild::get_divi_layouts();
        return self::response_success( $response );
    }
...
add_action(
    ...
    function() {
        ...
        $route->prefix( '/module-data' )->group(
            function( $router ) {
                $router->get( '/image-hotspot-child/get_divi_layouts', ImageHotspotChildModuleGetDiviLayoutsController::class );
            }
        );
        $route->prefix( '/module-data' )->group(
            function( $router ) {
                $router->get( '/image-hotspot-child/render_library_layout', ImageHotspotChildModuleRenderLibraryLayoutController::class );
            }
        );
    }
);