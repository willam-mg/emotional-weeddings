 ...
 */
class FilterableGridModuleGetFilterableGridDataController extends RESTController {
    ...
    public static function index( WP_REST_Request $request ): WP_REST_Response {
        ...
        $response = [
            'html' => FilterableGrid::get_filterable_grid_data(
...
/**
 * Register "Filterable Grid Module"'s REST API Route and endpoint.
 */
add_action(
    'init',
    function() {
        ...
        $route->prefix( '/module-data' )->group(
            function( $router ) {
                $router->get( '/filterable-grid/get_filterable_grid_data', FilterableGridModuleGetFilterableGridDataController::class );
            }
        );
    }
);