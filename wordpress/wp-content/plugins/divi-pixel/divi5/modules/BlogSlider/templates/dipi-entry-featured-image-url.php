...
if (isset($attachment[0])) {
    $image = $attachment[0];
    $image_desktop_url = self::get_attachment_image($attachment_id, $args['image_size'], $image);
    $image_tablet_url = self::get_attachment_image($attachment_id, $args['image_size_tablet'], $image);
    $image_phone_url = self::get_attachment_image($attachment_id, $args['image_size_phone'], $image);
