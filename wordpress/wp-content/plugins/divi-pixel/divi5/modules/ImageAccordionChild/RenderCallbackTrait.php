<?php
/**
 * ImageAccordionChild::render_callback()
 *
 * @package DIPI\Modules\ImageAccordionChild
 * @since ??
 */

namespace DIPI\Modules\ImageAccordionChild;
	...
	public static function render_callback( $attrs, $content, $block, $elements ) {
		...
		return Module::render(
			[
				...
				'classnamesFunction'  => [ ImageAccordionChild::class, 'module_classnames' ],
				'stylesComponent'     => [ ImageAccordionChild::class, 'module_styles' ],
				'scriptDataComponent' => [ ImageAccordionChild::class, 'module_script_data' ],
