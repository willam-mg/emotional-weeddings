...
class ImageMaskModuleGetThumbsUrlController extends RESTController {

    /**
     * Return unordered list of recent posts.
     */
    public static function index( WP_REST_Request $request ): WP_REST_Response {
        $response = plugins_url('/assets/', __FILE__);
...
add_action(
    ...
    function() {
        ...
        $route->prefix( '/module-data' )->group(
            function( $router ) {
                $router->get( '/image-mask/get_thumbs_url', ImageMaskModuleGetThumbsUrlController::class );
            }
        );
    }
);