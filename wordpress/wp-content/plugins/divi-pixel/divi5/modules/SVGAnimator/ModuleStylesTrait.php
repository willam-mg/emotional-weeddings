			...
			[
				...
				'styles'        => [
                    ...
                    CommonStyle::style([
						...
						'attr'                => static::getAttr($attrs, 'svg_width'),
                    ...
                    CommonStyle::style([
						'selector'            => "$order_class .dipi-svg-animator-container svg",
						'attr'                => static::getAttr($attrs, 'svg_height'),
						'declarationFunction' => function ( array $args ) {
                            $attrValue = $args['attrValue'];
                    ...
                    CommonStyle::style([
						'selector'            => "$order_class .dipi-svg-animator-container svg *",
						'attr'                => static::getAttr($attrs, 'svg_color'),
						'declarationFunction' => function ( array $args ) {
                            $attrValue = $args['attrValue'];
                            return "stroke: $attrValue !important;";
                        }
					]),
                    CommonStyle::style([
						'selector'            => "$order_class .dipi-svg-animator-container svg *",
						'attr'                => static::getAttr($attrs, 'svg_weight'),
						'declarationFunction' => function ( array $args ) {
                            $attrValue = $args['attrValue'];
                            return "stroke-width: $attrValue !important;";
                        }
					]),
                    CommonStyle::style([
						'selector'            => "$order_class .dipi-svg-animator-inner-wrapper",
						'attr'                => static::getAttr($attrs, 'align'),
						'declarationFunction' => function ( array $args ) {
                            $attrValue = $args['attrValue'];
