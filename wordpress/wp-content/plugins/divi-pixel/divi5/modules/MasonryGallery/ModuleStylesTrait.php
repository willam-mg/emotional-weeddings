...
trait ModuleStylesTrait
{
    ...
    public static function module_styles($args)
    {
        ...
        $overlay_icon_hover_selector = "{$order_class}.dipi_masonry_gallery .grid .grid-item .dipi_masonry_gallery_overlay .dipi-mansonry-gallery-icon:hover";
        ...
        $overlay_icon_circle_hover_selector = "{$order_class}.dipi_masonry_gallery .grid .grid-item .dipi_masonry_gallery_overlay .dipi-mansonry-gallery-icon.dipi-mansonry-gallery-icon-circle:hover";
        ...
        if($use_overlay === "on") {
            if($background_gradient)
            {
                $module_styles[] = CommonStyle::style([
                    'selector'            => "$order_class .grid .grid-item .dipi_masonry_gallery_overlay.background",
            ...
            {
                $module_styles[] = CommonStyle::style([
                    'selector'            => "$order_class .grid .grid-item .dipi_masonry_gallery_overlay.background-hover",
                    'attr'                => static::getAttr($attrs, 'icon_speed'),
            ...
            $module_styles[] = SpacingStyle::style([
            ...
            if($overlay_icon_use_circle === "on") {
                $module_styles[] = SpacingStyle::style([
                    'selector'            => $overlay_icon_circle_selector,
                    'attr'                => static::getAttr($attrs, 'overlay_icon_padding'),
                ]);
