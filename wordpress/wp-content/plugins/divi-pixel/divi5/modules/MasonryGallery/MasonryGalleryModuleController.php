 ...
 */
class MasonryGalleryModuleGetMasonryGalleryDataController extends RESTController {
    ...
    public static function index( WP_REST_Request $request ): WP_REST_Response {
        ...
        $response = [
            'html' => MasonryGallery::render_images(
...
/**
 * Register "Masonry Gallery Module"'s REST API Route and endpoint.
 */
add_action(
    'init',
    function() {
        ...
        $route->prefix( '/module-data' )->group(
            function( $router ) {
                $router->get( '/masonry-gallery/render_images', MasonryGalleryModuleGetMasonryGalleryDataController::class );
            }
        );
    }
);