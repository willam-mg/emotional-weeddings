 ...
 */
class BlogSliderModuleGetBlogPostsController extends RESTController {
    ...
    public static function index( WP_REST_Request $request ): WP_REST_Response {
        ...
        $response = [
            'html' => BlogSlider::get_blog_posts(
...
class BlogSliderModuleGetPostTypesController extends RESTController {

    /**
     * Return unordered list of recent posts.
     */
    public static function index( WP_REST_Request $request ): WP_REST_Response {
        $response = BlogSlider::get_post_types_and_taxonomies();
        return self::response_success( $response );
    }
...
add_action(
    ...
    function() {
        ...
        $route->prefix( '/module-data' )->group(
            function( $router ) {
                $router->get( '/blogslider/get_blog_posts', BlogSliderModuleGetBlogPostsController::class );
                $router->get( '/blogslider/get_post_types_and_taxonomies', BlogSliderModuleGetPostTypesController::class );
            }
        );
    }
);