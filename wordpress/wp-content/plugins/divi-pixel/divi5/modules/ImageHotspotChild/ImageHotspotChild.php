...
require_once(__DIR__ . '/ImageHotspotChildModuleController.php');

use ET\Builder\Framework\DependencyManagement\Interfaces\DependencyInterface;
use ET\Builder\Packages\ModuleLibrary\ModuleRegistration;
use DIPI\Traits\BaseModuleScriptDataTrait;

class ImageHotspotChild implements DependencyInterface
{
        ...
        add_action(
            ...
            function () use ($module_json_folder_path) {
                ModuleRegistration::register_module(
                    ...
                    [
                        'render_callback' => [ImageHotspotChild::class, 'render_callback'],
                    ]
                );
            }
        );
