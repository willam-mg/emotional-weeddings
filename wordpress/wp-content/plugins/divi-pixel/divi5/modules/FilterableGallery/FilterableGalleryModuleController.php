 ...
 */
class FilterableGalleryModuleGetFilterableGalleryDataController extends RESTController {
    ...
    public static function index( WP_REST_Request $request ): WP_REST_Response {
        ...
        $response = [
            'html' => FilterableGallery::get_filterable_gallery_data(
...
/**
 * Register "Filterable Gallery Module"'s REST API Route and endpoint.
 */
add_action(
    'init',
    function() {
        ...
        $route->prefix( '/module-data' )->group(
            function( $router ) {
                $router->get( '/filterable-gallery/get_filterable_gallery_data', FilterableGalleryModuleGetFilterableGalleryDataController::class );
            }
        );
    }
);